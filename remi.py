...
from tools.get_meals import main_ingredient
from tools.get_stores import get_places
...
main_ingredient_agent = create_react_agent(
    ...
    tools=[search_meal_by_name, main_ingredient, get_places],
    prompt=(
        ...
        "If the ingredient has spaces, replace the space with an underscore. "
        "DO NOT JUST SPIT OUT THE TOOL OUTPUT, TALK LIKE A REAL PERSON!!!!!!!"),name="main_ingredient_agent",)
